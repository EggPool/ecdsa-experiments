...
if __name__ == "__main__":
    ...
    signer = SignerFactory.from_private_key('e5b42f3c3fe02e161d42ff4707a174a5715b2badc7d4d3aebbea9081bd9123d5', SignerType.ECDSA)
    ...
    SignerFactory.verify_bis_signature(signature, public_key_net, buffer, 'Bis1SAk19HCWpDAThwFiaP9xA6zWjzsga7Hog')
    print("No Error")
    ...
    # Could as well be loaded from a wallet, no matter.
    signer = SignerFactory.from_private_key('e5b42f3c3fe02e161d42ff4707a174a5715b2badc7d4d3aebbea9081bd9123d5', SignerType.ED25519)
    print(signer.to_dict())
    assert(signer.to_dict()['address'] == 'Bis13AbAZwMeY1C5GuFuVuVKLSjr3RdKG63g4CEx6epwSbhpuDU3rj')
    ...
    SignerFactory.verify_bis_signature(signature, public_key_net, buffer, 'Bis13AbAZwMeY1C5GuFuVuVKLSjr3RdKG63g4CEx6epwSbhpuDU3rj')
    print("No Error")
